export default {
  main: {
    ...
    modal: {
      level: {
        up: 'Поздравляем, вы повысили свой уровень. Продолжайте в том же духе',
        down: 'Ваш уровень понизился',
        new: 'Новый уровень:'
      }
    }
  },
  ...
  rules: {
    ...
    3: 'Не забывай использовать монеты',
    4: 'Следи за своим прогрессом',
    5: 'Прокачивай свои умения, не забывая ни обо одном'
  },
  form: {
    name: {
